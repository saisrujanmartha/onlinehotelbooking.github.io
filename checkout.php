<?php
	...
	$sql = "SELECT CONCAT(name, '(',qty,')') AS ItemQty, total_price FROM tbl_booking";
  ...
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="index.php"><i class="fas fa-mobile-alt mr-2"></i>Rooms Booked</a>
        </li>
        <li class="nav-item">
