...
<body>
  <nav class="navbar navbar-expand-md bg-dark navbar-dark">
    <!-- Brand -->
    <a class="navbar-brand" href="index.php"><i class="fas fa-mobile-alt"></i>&nbsp;&nbsp;OHMS</a>
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item">
          <a class="nav-link active" href="index.php"><i class="fas fa-mobile-alt mr-2"></i>Rooms</a>
        </li>
        <li class="nav-item">
  ...
  echo $_SESSION['message'];
        ...
        <div class="table-responsive mt-2">
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              <?php
                $stmt = $con->prepare('SELECT * FROM tbl_booking');
                $stmt->execute();
              ...
              <tr>
                ...
                <td><img src="product-image/<?= $row['img'] ?>" width="50"></td>
                <td><?= $row['name'] ?></td>
                <td>
                  <i class="fas fa-usd-sign"></i>&nbsp;&nbsp;<?= number_format($row['cost'],2); ?>
                </td>
                <input type="hidden" class="cost" value="<?= $row['cost'] ?>">
                <td>
                  <input type="number" class="form-control qty" value="<?= $row['qty'] ?>" style="width:75px;">
                </td>
                <td><i class="fas fa-usd-sign"></i>&nbsp;&nbsp;<?= number_format($row['total_price'],2); ?></td>
                <td>
              ...
              <tr>
                ...
                <td><b><i class="fas fa-usd-sign"></i>&nbsp;&nbsp;<?= number_format($grand_total,2); ?></b></td>
                <td>
